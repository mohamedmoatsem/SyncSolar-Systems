          ...
          <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3">
            ...
            <div className="flex items-center gap-2 flex-wrap">
              <Select value={metric} onValueChange={setMetric}>
                <SelectTrigger className="w-full sm:w-[140px] h-8 text-xs font-mono">
              ...
              <Select value={hours} onValueChange={setHours}>
                <SelectTrigger className="w-full sm:w-[120px] h-8 text-xs font-mono">
          ...
          return (
            <Card key={key} className="bg-card/40 border-border">
              <CardContent className="p-3 sm:p-4">
                ...
                <div className="text-lg sm:text-xl font-data font-bold text-foreground mt-1">
